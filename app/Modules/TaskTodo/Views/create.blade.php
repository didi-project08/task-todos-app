...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    ...
    <form action="{{ route('task-todos.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="mb-4">
            ...
            <textarea name="todo" id="todo" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ketik todo...">{{ old('todo') }}</textarea>
